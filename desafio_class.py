...
class Conta:
    ...
    def depositar(self,valor_deposito):
        if valor_deposito > 0:
            ...
            print(f"Deposito de R$ {valor_deposito:.2f}\n")
        else:
    ...
    def sacar(self, valor_sacar):
        ...
        saldo = self.saldo
        exedeu_saldo = valor_sacar > saldo
        ...
        if exedeu_saldo:
            ...
            print(f"Saque de R$ {valor_sacar:.2f}\n")
            return True
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor_sacar):
        ...
        excedeu_limite = valor_sacar > self.limite
        ...
        if excedeu_limite:
            ...
            return super().sacar(valor_sacar)
